...
return (
  <div className="modules-page">
    <div className="modules-top">
      <div>
        <h2>Resources</h2>
        <p className="resources-help">
          Class files shared by your teacher and classmates.
        </p>
      </div>

      <div className="sort-box">
        <label htmlFor="fileSort">Sort by:</label>
    ...
    {!ordered.length && (
      <div className="page-state">
        No files have been shared with this class yet.
      </div>
    )}
        ...
        >
          <div className="module-card-top">
            ...
            <div
              ...
              ref={activeMenu === material.id ? menuRef : null}
            ...
            >
              <button
                ...
                onClick={() =>
                  setActiveMenu(
                    activeMenu === material.id ? null : material.id
                  )
                }
              >
              ...
              {activeMenu === material.id && (
                <div className="popup-menu">
                  <button onClick={() => download(material)}>
                  ...
                  {isTeacherForCourse && (
                    <>
                      <button onClick={() => rename(material)}>
          ...
          <p className="material-meta">
            {material.file
              ? readableSize(material.file_size)
              : "External resource"}{" "}
              •  {"     "}
            {material.uploaded_by_name?.trim() ||
    ...
    {canUpload && (
      <>
        <input
          ...
          type="file"
          multiple
          accept=".pdf,.doc,.docx,.ppt,.pptx,.xls,.xlsx,.txt,.csv,.zip,.png,.jpg,.jpeg,.gif"
          style={{ display: "none" }}
          onChange={upload}
        />
